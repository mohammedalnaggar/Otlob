...
class OrderDetailsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create order_detail" do
    assert_difference('OrderDetail.count') do
      post order_details_url, params: { order_detail: { amount: @order_detail.amount, comment: @order_detail.comment, item: @order_detail.item, orderUser_id: @order_detail.orderUser_id, price: @order_detail.price } }
    end
  ...
  test "should update order_detail" do
    patch order_detail_url(@order_detail), params: { order_detail: { amount: @order_detail.amount, comment: @order_detail.comment, item: @order_detail.item, orderUser_id: @order_detail.orderUser_id, price: @order_detail.price } }
